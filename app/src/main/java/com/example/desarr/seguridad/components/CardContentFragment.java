...
public class CardContentFragment extends Fragment {
     ...
     * specified {@link ListContentFragmentFragment.OnListFragmentInteractionListener}.
     * TODO: Replace the implementation with code for your data type.
     */
    public static class MyListContentFragmentRecyclerViewAdapter extends RecyclerView.Adapter<MyListContentFragmentRecyclerViewAdapter.ViewHolder> {

        private final List<DummyContent.DummyItem> mValues;
        private final ListContentFragmentFragment.OnListFragmentInteractionListener mListener;

        public MyListContentFragmentRecyclerViewAdapter(List<DummyContent.DummyItem> items, ListContentFragmentFragment.OnListFragmentInteractionListener listener) {
            mValues = items;
            mListener = listener;
        }
